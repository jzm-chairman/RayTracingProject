...
void Scene::build_scene()
{
	...
	Vec3 vase_controller[] = { Vec3(0, 4), Vec3(3, 16), Vec3(12, 16), Vec3(19, 0), Vec3(25, 0), Vec3(31, 8) };
	add_object(new Sphere(Vec3(1e5 + 1, 40.8, 81.6), new Texture(Vec3(0.1, 0.25, 0.25)), 1e5, false, DIFF)); //Left
	add_object(new Sphere(Vec3(-1e5 + 99, 40.8, 81.6), new Texture(Vec3(0.25, 0.75, 0.25)), 1e5, false, DIFF)); //Rght
	...
	add_object(new BezierVase(Vec3(73, 0, 78), 5, vase_controller, new Texture("2.jpg"), false, DIFF));
	add_object(new Sphere(Vec3(20, 60, 100), new Texture(Vec3(0.75, 0.25, 0.25)), 16.5, false, DIFF));//Glas
